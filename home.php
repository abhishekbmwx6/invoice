...
<?php
$query = "SELECT i.invoice_id,i.purches_date,i.total_after_tax,i.saler_id,u.user_id,u.name,u.contact,u.role,us.name as saler FROM `invoice` i inner join user u on i.user_id = u.user_id inner join user us on i.saler_id = us.user_id where i.status='active'";
